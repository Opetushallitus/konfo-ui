...
public class OphPrerenderFilter extends PreRenderSEOFilter {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (enablePrerender) {
            ...
            LOG.warn(String.format("ophPrerenderWrapper.enablePrerender == %s , not initialising service.", enablePrerender));
        }
    }
    ...
    protected Map<String, String> toMap(FilterConfig filterConfig) {
        ...
        config.put("socketTimeout", Integer.toString(socketTimeoutMillis)); // See PrerenderConfig.getSocketTimeout()
        return config;
    }
}
